...
#La siguiente función, compara un caracter ingresado por el usuario, con las entradas de un array, el cual contiene una serie
#de letras(consonantes, o vocales), y si llegan a coincidir, retorna un 1 (true).
